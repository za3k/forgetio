...
(function() {
  var afterLogger, app, beforeLogger, common, compiler, ect, ectRenderer, errorHandler, express, http, logger, loginUtilMiddleware, nconf, path, routeCommonConfig, routes;
  ...
  loginUtilMiddleware = function(req, res, next) {
    req.user = {
      ...
      fetch: function(next) {
        return common.getUser(req).success(function(user) {
          req.user._user = user;
          return next();
