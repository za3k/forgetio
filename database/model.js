...
(function() {
  var Phone, ReceivedMessage, Reminder, ReminderTime, SentMessage, Sequelize, TimeZone, User, UserPayment, common, communication, communication_admin, defaultID, define, extern, logger, nconf, pg, sequelize;
  ...
  module.exports.getCommunication = function(user, cb) {
    var query;
