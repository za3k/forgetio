...
var logger, model, nconf, offsetDisplayName, offsetToHoursAndMinutes, syncDone, timeOfDayDisplayName, timezoneDone, v, _;
...
module.exports.sync = function(cb) {
  if (syncDone) {
    return cb(module.exports);
  } else {
    return timezoneDone = function() {
      cb(module.exports);
...
module.exports.successFail = function(dbcall, cb) {
  return dbcall.success(function(x) {
    return cb(x);
  }).failure(function(x, err) {
